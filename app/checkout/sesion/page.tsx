...
function SessionCheckoutContent() {
  ...
  // Prices
  const PRICES = {
    single: { COP: 300000, USD: 100, EUR: 100 },
  ...
  const basePrice = useUSD ? currentPrice.USD : currentPrice.COP;
  const displayCurrency: "COP" | "USD" = useUSD ? "USD" : "COP";
  const displayPrice = appliedDiscount ? appliedDiscount.finalAmount : basePrice;
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
            ...
            <div className="lg:col-span-2">
              <div className="bg-white rounded-2xl shadow-lg p-6 lg:sticky lg:top-8">
                <h2 className="font-gazeta text-2xl text-[#8A4BAF] mb-6">Resumen de tu compra</h2>
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center gap-3">
                      ...
                      <span className="font-dm-sans text-gray-700">Duración: 120 minutos</span>
                    </div>

                    <div className="flex items-center gap-3">
                      <Video className="w-5 h-5 text-[#8A4BAF]" />
                      <span className="font-dm-sans text-gray-700">Modalidad: Videollamada</span>
                    </div>
                  ...
                  <div className="pt-4 border-t border-gray-100">
                    {appliedDiscount && (
                      <div className="flex items-baseline justify-between mb-1">
                        <span className="font-dm-sans text-gray-400 text-sm line-through">
