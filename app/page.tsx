...
import { getRandomTestimonials, type Testimonial } from "@/lib/sanity/queries/testimonials";
...
export default async function HomePage() {
  ...
  try {
    ...
    // Sanity no configurado: omitir meditaciones destacadas
  }

  let testimonials: Testimonial[] = FALLBACK_TESTIMONIALS;
  try {
    const fetched = await getRandomTestimonials(3);
    if (fetched && fetched.length > 0) {
      testimonials = fetched;
    }
  } catch (_error) {
    // Sanity no configurado o sin testimonios: usar fallback
  }
            ...
            <div className="text-white max-w-2xl py-12 lg:py-20 relative z-10">
              ...
              <div className="space-y-3 pt-4">
                <div className="flex items-start gap-3">
                  <svg
                    className="w-6 h-6 text-[#654177] flex-shrink-0 mt-0.5"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
            ...
            <div className="bg-white/90 backdrop-blur-sm rounded-2xl p-6 sm:p-8 shadow-lg hover:shadow-2xl hover:-translate-y-2 transition-all duration-300">
              ...
              <ul className="space-y-3">
                <li className="flex items-start gap-3">
                  ...
                  <span className="font-dm-sans text-base text-[#4A4A4A]">
                    Sincronicidades e intuiciones
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="w-2 h-2 bg-[#8A4BAF] rounded-full mt-2 flex-shrink-0" />
            ...
            <div className="bg-white/90 backdrop-blur-sm rounded-2xl p-6 sm:p-8 shadow-lg hover:shadow-2xl hover:-translate-y-2 transition-all duration-300">
              ...
              <ul className="space-y-3">
                ...
                <li className="flex items-start gap-3">
                  <span className="w-2 h-2 bg-[#8A4BAF] rounded-full mt-2 flex-shrink-0" />
                  <span className="font-dm-sans text-base text-[#4A4A4A]">
                    Comprender tu proceso de cambio
                  </span>
                </li>
              </ul>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8 max-w-5xl mx-auto mb-10 sm:mb-12">
            ...
            <div className="group relative bg-white rounded-2xl p-8 sm:p-10 shadow-lg hover:shadow-2xl transition-all duration-300 border border-[#8A4BAF]/10 flex flex-col">
              ...
              <p className="font-dm-sans text-[#674c6a] text-base leading-relaxed mb-6 min-h-[72px]">
                Una canalización personalizada donde recibes mensajes específicos para tu situación
                actual. Ideal si buscas respuestas concretas.
              </p>
              ...
              <ul className="space-y-3 mb-8 flex-grow">
                <li className="flex items-center gap-3">
                  <svg
                    className="w-5 h-5 text-[#8A4BAF] flex-shrink-0"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
                  ...
                  <span className="font-dm-sans text-sm text-[#4A4A4A]">
                    Mensaje canalizado para tu momento
                  </span>
                </li>
                <li className="flex items-center gap-3">
                  <svg
            ...
            <div className="group relative bg-white rounded-2xl p-8 sm:p-10 shadow-lg hover:shadow-2xl transition-all duration-300 border border-[#2D4CC7]/10 flex flex-col">
              ...
              {/* Title */}
              <h3 className="font-gazeta text-2xl sm:text-3xl text-[#2D4CC7] mb-2">Membresía</h3>
              ...
              <p className="font-dm-sans text-[#4a5a7a] text-base leading-relaxed mb-6 min-h-[72px]">
                Acceso a contenido exclusivo, meditaciones guiadas y comunidad. Perfecto si deseas
                integrar la espiritualidad en tu día a día.
              </p>
              ...
              <ul className="space-y-3 mb-8 flex-grow">
                <li className="flex items-center gap-3">
                  <svg
                    className="w-5 h-5 text-[#2D4CC7] flex-shrink-0"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
                ...
                <li className="flex items-center gap-3">
                  ...
                  <span className="font-dm-sans text-sm text-[#4A4A4A]">
                    Meditaciones y canalizaciones exclusivas
                  </span>
                </li>
                <li className="flex items-center gap-3">
                  <svg
              ...
              <div className="lg:col-span-3 order-2 space-y-5 md:space-y-6">
                <div>
                  ...
                  <div className="space-y-4 md:space-y-5">
                    ...
                    <p className="font-dm-sans text-base md:text-lg text-[#4A4A4A] leading-relaxed">
                      Mi camino de luz inició hace 14 años, con la muerte de mi abuelo, quien me
                      llevó a conectarme con la fuente.
                    </p>

                    <p className="font-dm-sans text-base md:text-lg text-[#4A4A4A] leading-relaxed">
                      Hoy me dedico a compartir mis dones con el mundo, ayudándoles a sanar y a
                      encontrar respuestas en los seres de luz para lograr una evolución del ser.
                    </p>
                    ...
                    <div className="relative pl-6 border-l-4 border-[#8A4BAF] py-2">
                      <p className="font-dm-sans text-base md:text-lg text-[#674c6a] leading-relaxed italic">
                        &ldquo;Por medio de la sanación, la contención y los mensajes que nutren el
                        alma, guiando el camino a un nuevo despertar de conciencia.&rdquo;
                      </p>
                    </div>
                  </div>
                </div>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="text-center mb-12 sm:mb-14 md:mb-16">
              ...
              <p className="font-dm-sans text-base sm:text-lg text-[#4a5a7a] max-w-3xl mx-auto">
                Aprende, desarrolla y profundiza en tu camino espiritual con nuestros cursos y
                talleres
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
              ...
              <div className="group bg-gradient-to-b from-white to-[#eef1fa]/30 rounded-2xl shadow-lg p-6 sm:p-8 border border-[#2D4CC7]/10 hover:shadow-xl transition-all">
                ...
                <p className="font-dm-sans text-sm sm:text-base text-[#4A4A4A] leading-relaxed text-center mb-5">
                  Descubre y desarrolla tu capacidad de canalización para conectar con los seres de
                  luz.
                </p>
                <div className="text-center">
                  <Link
              ...
              <div className="group bg-gradient-to-b from-white to-[#eef1fa]/30 rounded-2xl shadow-lg p-6 sm:p-8 border border-[#2D4CC7]/10 hover:shadow-xl transition-all">
                ...
                <p className="font-dm-sans text-sm sm:text-base text-[#4A4A4A] leading-relaxed text-center mb-5">
                  Formaciones completas para profundizar en tu desarrollo espiritual y
                  transformación.
                </p>
                <div className="text-center">
                  <Link
              ...
              <div className="text-center mb-12 sm:mb-14 md:mb-16">
                <div className="flex justify-center mb-5">
                  <div className="w-14 h-14 sm:w-16 sm:h-16 flex items-center justify-center bg-gradient-to-br from-[#8A4BAF]/10 to-[#654177]/10 rounded-full">
                    <svg
                      className="w-8 h-8 sm:w-10 sm:h-10 text-[#8A4BAF]"
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
