    ...
    return (
      <div className="space-y-6">
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-12 text-center">
          ...
          <h2 className="font-gazeta text-2xl text-[#654177] mb-2">Aún no tienes cursos</h2>
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h1 className="font-gazeta text-3xl text-[#654177]">Mis Cursos</h1>
        <Link href="/academia" className="text-sm text-[#4944a4] hover:underline font-dm-sans">
          Explorar más cursos
        </Link>
      </div>
