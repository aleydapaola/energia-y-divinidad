...
export const metadata: Metadata = {
  title: 'Pago con PayPal | Energía y Divinidad',
  description: 'Completa tu pago con PayPal',
}

export default async function PayPalPaymentPage({
  params,
  searchParams,
}: PayPalPaymentPageProps) {
        ...
        <div className="max-w-2xl mx-auto">
          ...
          <div className="bg-brand/5 rounded-lg p-8 text-center">
            ...
            <p className="text-primary/70 mb-6">
              La integración con PayPal estará disponible muy pronto. Por ahora, puedes contactarnos directamente para coordinar tu pago.
            </p>
            <a
