            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              {course.description && (
                <div className="bg-white rounded-xl shadow-sm p-6">
                  <h2 className="font-gazeta text-2xl text-[#654177] mb-4">Descripción</h2>
              ...
              {course.requirements && course.requirements.length > 0 && (
                <div className="bg-white rounded-xl shadow-sm p-6">
                  <h2 className="font-gazeta text-2xl text-[#654177] mb-4">Requisitos</h2>
                  <ul className="space-y-2">
                    {course.requirements.map((req, index) => (
                      <li key={index} className="flex items-start gap-3 text-gray-600 font-dm-sans">
              ...
              <CourseContent
                ...
                onLessonClick={(lessonId) => {
                  window.location.href = `${coursePlayerHref}?lesson=${lessonId}`;
                }}
              ...
              {course.instructor && (
                <div className="bg-white rounded-xl shadow-sm p-6">
                  <h2 className="font-gazeta text-2xl text-[#654177] mb-4">Tu Instructora</h2>
                  <p className="text-gray-600 font-dm-sans">{course.instructor}</p>
                </div>
              )}
            </div>
