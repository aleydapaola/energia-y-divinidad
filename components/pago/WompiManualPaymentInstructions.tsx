  ...
  return (
    <div className="bg-white rounded-2xl border border-gray-200 p-6 space-y-6">
      ...
      <div className="text-center">
        ...
        <h2 className="font-gazeta text-2xl text-[#654177] mb-2">Pago Pendiente con Wompi</h2>
      ...
      <div className="bg-yellow-50 rounded-xl p-4 border-2 border-yellow-300">
        ...
        <div className="flex items-center justify-between gap-2 bg-white rounded-lg p-3 border border-yellow-200">
          <code className="font-mono text-lg font-bold text-[#654177]">{orderNumber}</code>
          <button
            type="button"
      ...
      <div className="space-y-4">
        <h3 className="font-gazeta text-lg text-[#654177]">Cómo realizar el pago</h3>
        ...
        <div className="space-y-3">
              ...
              {paymentLinkUrl ? (
                ...
                <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 space-y-3">
                  <div className="flex items-center gap-2">
                    <AlertCircle className="w-5 h-5 text-yellow-600" />
                    <span className="font-dm-sans text-sm text-yellow-800 font-medium">
                      El link de pago aún no está configurado.
                    </span>
                  </div>
                  <p className="font-dm-sans text-sm text-yellow-700">
                    Por favor escríbenos por WhatsApp indicando tu número de orden y te enviamos el
                    link de pago de inmediato.
                  </p>
                  <a
                    href={`https://wa.me/573151165921?text=Hola!%20Quiero%20pagar%20con%20Wompi.%20Mi%20número%20de%20orden%20es:%20${orderNumber}`}
                    target="_blank"
                    rel="noopener noreferrer"
          ...
          <div className="flex gap-3">
            ...
            <div>
              <p className="font-dm-sans font-medium text-gray-900">Completa el pago en Wompi</p>
              <p className="font-dm-sans text-sm text-gray-600">
        ...
        <div className="flex gap-3">
          ...
          <div className="flex-1">
            ...
            <p className="font-dm-sans text-sm text-green-700 mb-3">
              Para confirmar tu pago más rápido, envíanos una captura del comprobante de Wompi junto
      ...
      <div className="bg-blue-50 rounded-xl p-4 border border-blue-200">
        <div className="flex gap-3">
          ...
          <div>
            <p className="font-dm-sans font-medium text-blue-900 mb-1">¿Qué pasa después?</p>
            <p className="font-dm-sans text-sm text-blue-700">
              Una vez verifiquemos tu pago en Wompi, activaremos tu compra y recibirás un email de
              confirmación. Enviar el comprobante por WhatsApp acelera este proceso.
            </p>
          </div>
        </div>
      </div>
