...
export function PaymentMethodSelector({
  ...
  const handleCardTokenized = (data: WompiCardTokenData) => {
    if (!selectedRegion || !onRecurringCardSetup) {
      return;
    }
    onRecurringCardSetup(
      data,
  ...
  const handleRegionSelect = (region: PaymentRegion) => {
    ...
    const recommendedMethod = isMembership
              ...
              <div className="grid grid-cols-2 gap-2 sm:gap-3">
                ...
                >
                  <div className="flex flex-col items-center gap-1 sm:gap-2">
                    ...
                    <span className="font-dm-sans font-medium text-sm sm:text-base text-gray-900">
                      Colombia
                    </span>
                  ...
                  {currentOptions.map((option) => (
                    ...
                    >
                      ...
                      <div className="text-left min-w-0">
                        <p className="font-dm-sans font-semibold text-sm sm:text-base text-gray-900">
                          {option.label}
                        </p>
                        <p className="font-dm-sans text-xs sm:text-sm text-gray-500 truncate">
                          {option.description}
                        </p>
                      </div>
                    </button>
            ...
            {needsGuestEmail && selectedMethod && (
              <div className="p-4 sm:p-6 border-b border-gray-100">
                ...
                <p className="mt-3 font-dm-sans text-xs text-gray-500">
                  Recibirás la confirmación de tu compra en este email. Después podrás crear una
                  cuenta para acceder a tu historial.
                </p>
              </div>
            )}
